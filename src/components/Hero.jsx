      ...
      <div className="container hero-content">
        ...
        <div className="hero-text-side" style={{ maxWidth: '550px' }}>
          ...
          <div className="hero-actions reveal-up delay-3" style={{ display: 'flex', gap: '1rem' }}>
            ...
            <a href="#" className="btn btn-secondary magnetic-btn" download style={{ padding: '14px 32px', fontSize: '1rem', borderRadius: '100px', fontWeight: 600, display: 'inline-flex', alignItems: 'center', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
